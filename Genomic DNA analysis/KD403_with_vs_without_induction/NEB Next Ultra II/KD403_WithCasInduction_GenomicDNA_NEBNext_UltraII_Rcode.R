...
setwd("D:/Genomic_DNA_ds/403_plus_I")





#In this run we had 1x75 reads


reads_F<-readFastq("KD403_WithCasInduction_GenomicDNA_NEBNext_UltraII.fastq")#reads_F contains all reads together 
