...
setwd("D:/Genomic_DNA_ds/403_minus_I")





#In this run we will analyze 1x75 reads


reads_F1<-readFastq("KD403_NoCasInduction_GenomicDNA_NEBNext_UltraII_1.fastq")
reads_F2<-readFastq("KD403_NoCasInduction_GenomicDNA_NEBNext_UltraII_2.fastq")

reads_F<-append(reads_F1, reads_F2) #reads_F contains all reads together 
length(reads_F)
