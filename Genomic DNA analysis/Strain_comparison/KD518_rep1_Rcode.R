...
reads_F<-readFastq("Strain_comparison_experiment_KD518_WithCasInduction_GenomicDNA_NEBNext_UltraII_Rep1.fastq") #reads_F contains all reads
length(reads_F)
