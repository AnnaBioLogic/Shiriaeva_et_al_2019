...
setwd("E:/Genomic DNA/2.2")




reads_F<-readFastq("Strain_comparison_experiment_KD753_WithCasInduction_GenomicDNA_NEBNext_UltraII_Rep2.fastq") #reads_F contains all reads 
length(reads_F)
