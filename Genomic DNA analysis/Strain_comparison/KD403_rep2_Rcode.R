...
setwd("E:/Genomic DNA/3.2")




reads_F<-readFastq("Strain_comparison_experiment_KD403_WithCasInduction_GenomicDNA_NEBNext_UltraII_Rep2.fastq") #reads_F contains all reads 
length(reads_F)
