...
setwd("E:/Genomic DNA/1.1")




reads_F<-readFastq("Strain_comparison_experiment_KD263_WithCasInduction_GenomicDNA_NEBNext_UltraII_Rep1.fastq") #reads_F contains all reads 
length(reads_F)
