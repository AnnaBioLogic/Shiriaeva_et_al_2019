...
reads_F<-readFastq("Demo_total_genomic_DNA.fastq") #reads_F contains all reads 
length(reads_F)
...
##Whole genome plot
plot(UNCOV1_vector, type="h", xlim=c(1, width(mychr)), ylim=c(0, 200), xlab="bp", ylab="Coverage", main=name )

#################plot PPS-/+300kb

plot(UNCOV1_vector, type="h", xlim=c(275539, 875570), ylim=c(0, 200), xlab="bp", ylab="Coverage", main=name )
