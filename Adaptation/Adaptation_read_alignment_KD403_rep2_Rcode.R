...
rm(list=ls())
setwd("D:/Results/Selftargeting/Adaptation/HTS/3.2")

ID="KD403_rep.2"

reads_F<-readFastq("Primed_adaptation_KD403_rep2")
length(reads_F)
  ...
  P_start<-(-2) #Indicate you PAM start position with respect to the spacer start (If=(-2), it means that PAM starts 2 letters upstream of the spacer start coordinate)
  P_end<-(-0) #Indicate you PAM end position with respect to the spacer start (If=(0), it means that PAM end position is the same as the spacer start coordinate like in E.coli type I-E)
  spacer_length<-33
